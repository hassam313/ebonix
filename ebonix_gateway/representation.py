...
class RepresentationEngine:
    ...
    async def detect_person(self, image_b64: str, mime_type: str, google_api_key: str = "") -> Dict[str, Any]:
        """
        ...
        if not api_key:
            logger.warning("detect_person: no Google API key — defaulting style-only")
