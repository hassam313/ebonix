 ...
 */
{
	...
	return array(
		...
		'aitwin'              => 'king-pages/aitwin.php',
		'myplan'              => 'king-pages/myplan.php',
		'landing'             => 'king-pages/landing.php',
		'gallery'             => 'king-pages/questions.php',
		'aichat'              => 'king-pages/aichat.php',
	);
}
...
// ── Ebonix: always serve landing page at / for everyone ─────────────────────
$_ebx_request = strtolower(qa_request());
if ($_ebx_request === '' || $_ebx_request === 'home') {
    global $qa_request;
    $qa_request = 'landing';
}
// ──────────────────────────────────────────────────────────────────────────
