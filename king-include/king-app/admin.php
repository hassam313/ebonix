...
*/
	{
		...
		if ($level>=QA_USER_LEVEL_ADMIN) {
			...
			$navigation['admin/membership']=array(
				...
				'selected_on' => array('admin/membership$', 'admin/plans$', 'admin/topuppacks$', 'admin/credits$', 'admin/homepage$', 'admin/adfree$', 'admin/creditsopt'),
			);
...
*/
	{
		...
		if ($level>=QA_USER_LEVEL_ADMIN) {
			if ('mem' === $subtitle) {
				...
				$navigation['admin/plans']=array(
					'label' => 'Plans',
					'url' => qa_path_html('admin/plans'),
				);

				$navigation['admin/topuppacks']=array(
					'label' => 'Top-Up Packs',
					'url' => qa_path_html('admin/topuppacks'),
				);
