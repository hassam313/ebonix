...
class Ebonix_Gateway {
    ...
    public static function generate_image($prompt, $model, $size, $style, $negative_prompt, $image_data = null) {
        ...
        $payload = [
            ...
            'fal_api_key'          => (string)qa_opt('king_sd_api'),
            'google_api_key'       => (string)qa_opt('gemini_api'),
            'luma_api_key'         => (string)qa_opt('luma_api'),
            'decart_api_key'       => (string)qa_opt('decart_api'),
            'openai_api_key'       => (string)qa_opt('king_leo_api'),
        ];
